...
The effectful package provides utilities for testing effect programs without requiring real infrastructure. Tests use pytest-mock to create controlled test doubles.
...
**Usage**:
```python
from effectful import run_ws_program, Ok
from effectful.testing import assert_ok
...
from effectful.testing import assert_err
...
```python
from effectful import run_ws_program
from effectful.testing import unwrap_err
from effectful.interpreters.errors import DatabaseError
...
```python
from effectful import run_ws_program
from effectful.testing import assert_err_message

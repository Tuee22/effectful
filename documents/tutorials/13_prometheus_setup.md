...
**See Also**: [Alert Rules Tutorial](./14_alert_rules.md) for complete guide.
...
**See Also**: [Grafana Dashboards Tutorial](./15_grafana_dashboards.md) for complete guide.
...
**See Also**: [Alert Rules Tutorial](./14_alert_rules.md)
...
1. **Create Alert Rules** - Set up alerts for high error rates, slow queries
   - See [14_alert_rules.md](./14_alert_rules.md)

2. **Build Grafana Dashboards** - Visualize metrics with beautiful dashboards
   - See [15_grafana_dashboards.md](./15_grafana_dashboards.md)

3. **Integrate with Applications** - Add metrics to your effectful programs
   - See [11_metrics_quickstart.md](./11_metrics_quickstart.md)

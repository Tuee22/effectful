...
**Prerequisites**: Basic understanding of effectful programs and generators.
...
1. **Metric Types Guide** - When to use Counter vs Gauge vs Histogram vs Summary
   - See [12_metric_types_guide.md](./12_metric_types_guide.md)

2. **Prometheus Setup** - Run Prometheus/Grafana in Docker
   - See [13_prometheus_setup.md](./13_prometheus_setup.md)

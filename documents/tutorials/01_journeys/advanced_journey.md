...
**Supersedes**: none
**Referenced by**: demo/healthhub/documents/tutorials/01_journeys/advanced_journey.md

> **Purpose**: Base SSoT placeholder for Advanced Journey. Demo overlays must list deltas only.

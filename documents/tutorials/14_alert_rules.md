...
2. ✅ Understand severity levels (critical, warning, info)
3. ✅ Configure alert thresholds and durations
4. ✅ Test alerts before deploying
5. ✅ Integrate with Alertmanager for notifications
...
3. Verify alert groups appear (e.g., `effectful_slo_alerts`)
4. Check "State" column (should be "inactive" or "pending")
...
2. Expression evaluates to true: Check value > threshold
3. `for` duration passed: Wait full duration
4. Alert rules loaded: Status → Rules

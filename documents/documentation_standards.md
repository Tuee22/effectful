...
**Supersedes**: previous Unified Documentation Guide
**Referenced by**: CLAUDE.md, PURITY_REFACTOR.md, README.md, documents/api/README.md, documents/api/auth.md, documents/api/effects.md, documents/api/interpreters.md, documents/api/messaging.md, documents/api/programs.md, documents/api/result.md, documents/api/storage.md, documents/domain/appointment_workflows.md, documents/domain/hipaa_compliance.md, documents/domain/medical_state_machines.md, documents/dsl/intro.md, documents/engineering/README.md, documents/engineering/architecture.md, documents/engineering/authentication.md, documents/engineering/build_artifact_management.md, documents/engineering/code_quality.md, documents/engineering/command_reference.md, documents/engineering/development_workflow.md, documents/engineering/docker_workflow.md, documents/engineering/effect_patterns.md, documents/engineering/features/README.md, documents/engineering/features/appointments.md, documents/engineering/features/authentication.md, documents/engineering/features/invoices.md, documents/engineering/features/lab_results.md, documents/engineering/features/prescriptions.md, documents/engineering/functional_catalogue.md, documents/engineering/monitoring_and_alerting.md, documents/engineering/testing.md, documents/engineering/testing_architecture.md, documents/engineering/total_pure_modelling.md, documents/engineering/warnings_policy.md, documents/product/README.md, documents/product/roles/README.md, documents/product/workflows/README.md, documents/readme.md, documents/tutorials/00_library_deltas/README.md, documents/tutorials/00_library_deltas/adts_and_results.md, documents/tutorials/00_library_deltas/advanced_composition.md, documents/tutorials/00_library_deltas/effect_types.md, documents/tutorials/00_library_deltas/messaging_effects.md, documents/tutorials/00_library_deltas/migration_guide.md, documents/tutorials/00_library_deltas/production_deployment.md, documents/tutorials/00_library_deltas/quickstart.md, documents/tutorials/00_library_deltas/testing_guide.md, documents/tutorials/01_journeys/README.md, documents/tutorials/01_journeys/advanced_journey.md, documents/tutorials/01_journeys/beginner_journey.md, documents/tutorials/01_journeys/intermediate_journey.md, documents/tutorials/README.md, documents/tutorials/adts_and_results.md, documents/tutorials/advanced_composition.md, documents/tutorials/alert_rules.md, documents/tutorials/auth_effects.md, documents/tutorials/effect_types.md, documents/tutorials/grafana_dashboards.md, documents/tutorials/messaging_effects.md, documents/tutorials/metric_types_guide.md, documents/tutorials/metrics_quickstart.md, documents/tutorials/migration_guide.md, documents/tutorials/production_deployment.md, documents/tutorials/prometheus_setup.md, documents/tutorials/quickstart.md, documents/tutorials/storage_effects.md, documents/tutorials/testing_guide.md, demo/healthhub (48 files), dsl/verification_boundary.md
...
1. **Core SSoTs** (architecture, prerequisites, code quality, domain core)
1. **Patterns / how-tos** (command patterns, deployment guides, workflows)
1. **Generated reference** (command reference, metrics, functional catalogue)
...
- Use **relative links with section anchors** where possible; prefer deep links:
  ...
  - `[Testing](engineering/testing.md#core-testing-philosophy)`
...
- Optional callout for clarity:
  ...
  ```markdown
  > **📖 See**: [Engineering Standards Hub](engineering/README.md#ssot-link-map)
  ```
...
## Gitignore and Dockerignore Rules

- Generated artifacts (formatters, lockfiles, compiled assets) must be excluded per `engineering/build_artifact_management.md`.
- `.gitignore` and `.dockerignore` must list any new generated files added by documentation tooling.
- Validate ignores when adding new tools (e.g., markdown linters) to keep containers clean.
...
1. That block must carry **structured metadata** (`%% kind:`, `%% id:`, …).
1. It is automatically indexed in the **Functional Catalogue** (§11).
...
|--------------|---------------------------------|---------------|-------------------------|-----|
| ADT          | core.result.Result              | Result        | core.result             | [Code Quality](engineering/code_quality.md#2-adts-over-optional-types) |
| StateMachine | payments.checkout.CheckoutFlow  | CheckoutFlow  | payments.checkout       | [Payments](engineering/architecture.md#effect-execution-flow) |
```
...
1. **Cross-References section (optional)**
...
1. **Mermaid and functional canon**
...
1. **Integration with `poetry run check-code`**

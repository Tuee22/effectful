...
>
> Ok so that was the intro the AI wrote me for this document. I don't know about you but I'm really not having it. I want to write about how a year of vibe voding has gotten me to take a compleltely new look at my relationship with techonlogy. And the lens through which I use it to see myself. And that this is actually a closed and self-referential loop.
>
> And this is not some witty wordplay either, I am making a serious attempt t 
>
>
>
> What technology is, and what my continuous, incessant, constant fascination with it is actually telling me about myself, the world I live in, the people around me.
>
> If you don't know me, you're probably wondering why you're here. If you do ... you've probably already checked the word length of this document. 
>
> That's a pretty clichee weaksauce intro if you ask me. (The AI one I mean ! Not mine. Mine was cute. It's not quite Keats. But maybe good enough that my audiobook narrator could be Keneau Reeves ? Modest aspirations.) Ok dad jokes aside (my AI editor says this is the last one) ... the AI writing I asked for was beyond terrible. I mean don't you find that opening with three rooms so ... engaging ? Why do we need to picture the scenes in rooms ? No reason ! Just pointless words, the key to any well-written document. But it's there because it's kinda what I asked for : a suspenceful Hararian narrative with playful self-referential touches in the sprit of Godel-Escher-Bach. 
>
> The concluding section was titled "A Gentle Godelian Smile". I left it that way just for the self-referential humour. You may or may not know who Godel is. But seriously though : "A Gentle Godelian Smile". Isn't there something about that title that just feels a bit ... off ? Godel is always there self-referentially, grinning like the the chershire cat. Always. Gently. 
>
> tl;dr after getting a ton of help with research and organization, I am writing this "by hand" because there is absolutely no way an LLM 
>
> The thing is, I vibe coded this entire document using AI. Or at least, that's the pop culture term for using LLM to generate text that lives inside a code repository. (Namely, the Markdown document you're reading right now, which github.com is kindly hosting for me since, like most coders, most common nomenclature for the way I'm using AI right now. (Although I'm not actually using AI *RIGHT* now, because *RIGHT* now I'm typing in my on voice at the keyboard-- so at least this sentence isn't vibe coding.)
>
> But that doesn't quite work either. Because the document that sits in front of me now -- indeed the very same proof_boundary.md, which lives in the very same code repo at my personal github.com account. 
>
>
> So let me try again to describe what I did to make this document : I used LLM tools like Claude and ChatGPT
>
>
> How come, in most domains, humans are comfortable supervising AI but not delegating it decision-making responsiblity ? It would not be hard : use MCP to hook the model to the same API in the examples above.
>
> BTW don't fell like you click the links to follow the narrative. But please do click them if you want to fact check my sources and verify what I'm saying is true ! Actually what I'm about to say is pretty conjectural 
>
> Don't feel like you have to click those links inless you're interested.) I mean, can't AI send an email, approve a treatment plan, and resolve a safety ticket ? And I don't mean by 
>
> The [trolley problem](https://en.wikipedia.org/wiki/Trolley_problem) poses a simple scene with two outcomes: pull the lever and save five but kill one, or do nothing and kill five. The situation is decidable in the mechanical sense: outcomes are enumerable and rules can be written down. A model could be 
>

...
stateDiagram-v2
  %% kind: StateMachine
  %% id: product.appointments.Lifecycle
  %% summary: Patient appointment lifecycle from request through completion

  [*] --> Requested
  Requested --> Confirmed: doctor_confirms
  Requested --> Cancelled: patient_cancels
  Confirmed --> InProgress: appointment_starts
  Confirmed --> Cancelled: doctor_cancels
  InProgress --> Completed: visit_completed
  InProgress --> Cancelled: doctor_cancels
```
...
1. **Backend Processing**:
   ...
   ```python
   # effect program: create requested appointment
...
1. **Backend Processing**:
   ...
   ```python
   # effect program: confirm requested appointment
...
1. **Backend Processing**:
   ...
   ```python
   # effect program: start confirmed appointment
...
1. **Backend Processing**:
   ...
   ```python
   # effect program: complete appointment with notes
...
1. **Backend Processing**:
   ...
   ```python
   # effect program: generate invoice for completed appointment

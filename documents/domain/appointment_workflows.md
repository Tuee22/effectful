...
**Supersedes**: none  
**Referenced by**: demo/healthhub/documents/domain/appointment_workflows.md

> **Purpose**: SSoT for modelling appointment lifecycle workflows (scheduling, rescheduling, cancellation, follow-up) using the medical state machine patterns.

...
**Supersedes**: none  
**Referenced by**: demo/healthhub/documents/domain/medical_state_machines.md

> **Purpose**: SSoT for healthcare-specific state machines and lifecycle modelling; extends the base effect patterns for long-running workflows.

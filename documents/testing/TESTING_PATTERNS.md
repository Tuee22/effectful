...
The effectful library has a clean 4-layer architecture:
...
Following these patterns ensures consistent, maintainable, and type-safe tests across the entire effectful library.

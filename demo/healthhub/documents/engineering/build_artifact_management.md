...
> **📖 Authoritative Reference**: [Effectful build_artifact_management.md](../../../../documents/engineering/build_artifact_management.md)
> **📖 Base Standard**: [build_artifact_management.md](../../../../documents/engineering/build_artifact_management.md)

## Deltas

- Frontend build artifacts (React + Vite output to `/opt/healthhub/frontend-build/build/`)
- Frontend lock file regeneration pattern (npm)
- Backend lock guard with pip fallback for local path dependencies
...
1. Run `npm install --quiet` (generates fresh `package-lock.json`)
1. Run `npm run build` (uses freshly generated lock file)
...
**📖 See**: [docker.md - Environment Variables](docker.md#environment-variables-healthhub-specific) for complete HealthHub cache directory documentation.

______________________________________________________________________

## Lock Guard Pattern (HealthHub-Specific)

**Base pattern**: See [effectful build_artifact_management.md](../../../../documents/engineering/build_artifact_management.md) for shared lock guard rationale.
...
**Base lifecycle**: See [effectful build_artifact_management.md](../../../../documents/engineering/build_artifact_management.md) for shared patterns.
...
| Lock guard pattern (shared)          | [Effectful build_artifact_management.md](../../../../documents/engineering/build_artifact_management.md)                          |

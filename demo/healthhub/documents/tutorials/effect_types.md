...
> **Purpose**: HealthHub delta for the Effect Types tutorial.
> **📖 Authoritative Reference**: [effect_types.md](../../../../documents/tutorials/effect_types.md)

## Deltas
- Base SSoT: [effect_types.md](../../../../documents/tutorials/effect_types.md); apply all base steps and patterns.

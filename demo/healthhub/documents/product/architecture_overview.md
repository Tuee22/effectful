...
- **Authorization flow**: Routes enforce ADT-based authorization before invoking programs; no direct repository access from routes. See [Authorization Patterns](../engineering/authorization_patterns.md).
...
- FastAPI wiring and error mapping live in [FastAPI Integration Patterns](../engineering/fastapi_integration_patterns.md).
- State-machine orchestration for medical workflows is in [State Machine Patterns](../engineering/state_machine_patterns.md) and [Appointment State Machine](appointment_state_machine.md).

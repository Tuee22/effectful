...
Invariants:
- All PHI-accessing effects generate audit events
- Audit failures do not block healthcare operations
- Decorator pattern preserves underlying interpreter contract
"""

...
Pure orchestration logic - delegates actual I/O to outside boundary interpreters.

Invariants:
- All effects have a route (exhaustive routing)
- No effect is silently dropped
- Result types match effect contracts
"""

...
Effects are descriptions of operations, not execution - they are pure VALUES.
The notification interpreter (outside boundary) executes these via Redis/Pulsar.
"""

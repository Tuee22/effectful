...
**effectful** is a pure functional effect system for Python that brings algebraic data types, explicit error handling, and composable programs to async Python applications.
...
- [ ] Tests use fakes from effectful.testing
...
- **ADT Examples**: `effectful/domain/user.py`, `effectful/domain/cache_result.py`
- **Testing Utilities**: `effectful/testing/__init__.py`
- **Effect Programs**: `tests/test_integration/test_chat_workflow.py`
- **Type Aliases**: `effectful/programs/types.py`

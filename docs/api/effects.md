...
This document provides a comprehensive reference for all effect types in the functional-effects package.
...
**Usage**:
```python
from functional_effects import ReceiveText, SendText
...
**Usage**:
```python
from functional_effects import Close, CloseNormal, SendText
...
from functional_effects import GetUserById, SendText
...
```python
from uuid import UUID
from functional_effects import SaveChatMessage, SendText
...
```python
from uuid import UUID
from functional_effects import GetCachedProfile, GetUserById, SendText

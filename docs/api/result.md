...
```python
from functional_effects import Ok
...
```python
from functional_effects import Err
...
```python
from functional_effects import Result, Ok, Err
...
```python
from functional_effects import EffectReturn, SendText
...
```python
from functional_effects.algebraic.result import fold_result
...
```python
from functional_effects import Result, Err

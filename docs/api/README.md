...
Complete API documentation for the functional-effects package.

## Overview

The functional-effects package provides a type-safe, testable effect system for Python using algebraic data types (ADTs) and the Result type pattern.
...
from functional_effects import AllEffects, EffectResult, SendText
...
- [Tutorials](../tutorials/) - Step-by-step guides for learning functional-effects

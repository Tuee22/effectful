...
This tutorial guides you through migrating from imperative WebSocket code to functional-effects programs.

## Prerequisites

- Completed previous tutorials (01-06)
- Understanding of functional-effects architecture
...
- Incrementally adopt functional-effects in existing codebases
...
from functional_effects.domain import User, ChatMessage
...
async def websocket_chat_endpoint(websocket: WebSocket, user_id: str) -> None:
    ...
    if settings.use_functional_effects:
...
- Review [API Reference](../api/) for complete functional-effects API
...
- ✅ Migrate error handling to Result types
- ✅ Replace mutable state with immutable data flow
- ✅ Incrementally adopt functional-effects using feature flags and parallel implementations
- ✅ Test both imperative and functional code during migration

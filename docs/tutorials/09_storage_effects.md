...
This tutorial covers storage effects for **AWS S3** object storage operations in **functional_effects**.

## Storage Category

functional_effects provides storage effects for object storage operations:
...
```python
from functional_effects.effects.storage import DeleteObject
...
```python
from functional_effects.effects.storage import ListObjects
...
```python
from functional_effects.testing.failing import FailingStorageAdapter
...
```python
import boto3
from functional_effects.adapters.s3_storage import S3StorageAdapter
...
```python
from functional_effects.testing.fakes import FakeStorageAdapter

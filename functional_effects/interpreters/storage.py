...
from functional_effects.domain.s3_object import PutFailure, PutSuccess
...
class StorageInterpreter:
    ...
    Example:
        >>> from functional_effects.testing.fakes import FakeObjectStorage
        >>>
    ...
    def _is_retryable_put_failure(self, reason: str) -> bool:
        ...
        match reason:
            ...
            case "invalid_object_state":
                ...
                return True
            case _:
                # Unknown reason - assume not retryable
                return False
